...
Main() {
	case $RELEASE in
		...
		trixie)
			apt update -y
			apt install kde-plasma-desktop systemsettings plasma-workspace plasma-workspace-wallpapers kwin-wayland kwrite kdenetwork kcolorchooser kde-spectacle kgamma konsole gwenview plasma-pa udisks2 upower pulseaudio lightdm lightdm-gtk-greeter-settings pasystray f3 ghostscript libmtp-runtime vlc hyfetch synaptic htop usb-modeswitch blueman genisoimage gvfs-fuse inputattach system-config-printer transmission-qt tumbler mesa-utils gparted xarchiver p7zip zip unzip uuid-runtime mesa-utils-bin gvfs-backends gvfs-common soundconverter ffmpeg build-essential libcurl4-openssl-dev libalut-dev libsdl2-dev libsdl2-mixer-dev bluez-firmware alsa-utils lm-sensors libgtk-3-dev libgtk3-perl ffmpeg libavcodec-dev exfalso flac libjpeg-dev libglx-mesa0 libgl1-mesa-dri dbus build-essential libcurl4-openssl-dev libalut-dev libsdl2-dev libsdl2-mixer-dev libgtk-3-dev libgtk3-perl ffmpeg libavcodec-dev exfalso flac font-manager libjpeg-dev gufw handbrake audacious audacity putty gimp vlc-plugin-fluidsynth fluidsynth dsda-doom freedoom libglx-mesa0 libgl1-mesa-dri dosbox milkytracker cmake chromium build-essential dialog git nasm libgl1-mesa-dev libsdl2-dev flac libflac-dev libvpx-dev libgtk2.0-dev freepats ninja-build libzip-dev zipcmp zipmerge ziptool libsdl2-mixer-dev bash-completion alsa-utils apt-utils sudo libcurl4-openssl-dev firmware-sof-signed alsa-firmware-loaders libsdl2-net-dev cifs-utils vainfo vdpauinfo pciutils spek bison flex libsndfile1-dev glmark2* --no-install-recommends -y
			apt clean
			;;	
   		sid)
			apt update -y
			apt install kde-plasma-desktop systemsettings plasma-workspace plasma-workspace-wallpapers kwin-wayland kwrite kdenetwork kcolorchooser kde-spectacle kgamma konsole gwenview plasma-pa udisks2 upower pulseaudio lightdm lightdm-gtk-greeter-settings pasystray f3 ghostscript libmtp-runtime vlc hyfetch synaptic htop usb-modeswitch blueman genisoimage gvfs-fuse inputattach system-config-printer transmission-qt tumbler mesa-utils gparted xarchiver p7zip zip unzip uuid-runtime mesa-utils-bin gvfs-backends gvfs-common soundconverter ffmpeg build-essential libcurl4-openssl-dev libalut-dev libsdl2-dev libsdl2-mixer-dev bluez-firmware alsa-utils lm-sensors libgtk-3-dev libgtk3-perl ffmpeg libavcodec-dev exfalso flac libjpeg-dev libglx-mesa0 libgl1-mesa-dri dbus build-essential libcurl4-openssl-dev libalut-dev libsdl2-dev libsdl2-mixer-dev libgtk-3-dev libgtk3-perl ffmpeg libavcodec-dev exfalso flac font-manager libjpeg-dev gufw handbrake audacious audacity putty gimp vlc-plugin-fluidsynth fluidsynth dsda-doom freedoom libglx-mesa0 libgl1-mesa-dri dosbox milkytracker cmake chromium build-essential dialog git nasm libgl1-mesa-dev libsdl2-dev flac libflac-dev libvpx-dev libgtk2.0-dev freepats ninja-build libzip-dev zipcmp zipmerge ziptool libsdl2-mixer-dev bash-completion alsa-utils apt-utils sudo libcurl4-openssl-dev firmware-sof-signed alsa-firmware-loaders libsdl2-net-dev cifs-utils vainfo vdpauinfo pciutils sox bison flex libsndfile1-dev glmark2* --no-install-recommends -y
			apt clean
			;;	
		bionic)
			# your code here
